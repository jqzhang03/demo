...
+ ##### [分支管理工作流](#分支管理工作流)
+ ##### [代码合并](#代码合并)
+ ##### [如何选择合适的工作流](#如何选择合适的工作流)
+ ##### [常见问题2](#常见问题2)
#### [创建Github仓库实操](#创建Github仓库实操)

业界绝大多数公司都是基于Git进行代码管理，目前绝大多数开源社区项目都是基于Git维护的

### <span id="版本控制">版本控制</span>
|版本控制类型|代表性工具|解决的问题|
|-|-|-|
